# =======================================================================
# forecast3m.py
# VERSIÓN DEFINITIVA: Incluye la capa personalizada SlicerLayer para
# cargar el modelo causal correctamente.
# =======================================================================
...
# === CAMBIO CLAVE: DEFINIR LA CAPA PERSONALIZADA ===
...
def add_time_features(df):
    df_copy = df.copy()
    df_copy["dow"], df_copy["month"], df_copy["hour"] = df_copy.index.dayofweek, df_copy.index.month, df_copy.index.hour
...
# ... (El resto de funciones de post-procesamiento y Erlang son idénticas)
...
def main():
    ...
    # === CAMBIO CLAVE: Cargar el modelo con el custom_object ===
